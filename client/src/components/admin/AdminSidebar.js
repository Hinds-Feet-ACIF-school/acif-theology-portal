...
import { LayoutDashboard, BookOpen, Users, Settings, BarChart3, Sun, Moon } from 'lucide-react';
...
const AdminSidebar = () => {
    ...
    const [currentClientTheme, setCurrentClientTheme] = useState(theme);
    useEffect(() => {
