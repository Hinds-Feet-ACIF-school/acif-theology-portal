...
import { BookOpen, Calendar, Clock, Award, CheckCircle2, FileText, 
...
// const inputBgLight = "bg-[#FFF8F0]"; // Defined but not used in this component
// const inputBgDark = "dark:bg-gray-800"; // Defined but not used in this component
const contentBgLight = "bg-white";
const contentBgDark = "dark:bg-gray-900";
// const inputBorderLight = "border-[#E0D6C3]"; // Defined but not used in this component
// const inputBorderDark = "dark:border-gray-700"; // Defined but not used in this component
// const focusRingAccent = `focus:ring-[${accentColor}]`; // Defined but not used in this component
// const focusBorderAccent = `focus:border-[${accentColor}] dark:focus:border-[${accentColor}]`; // Defined but not used in this component
