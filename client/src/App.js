...
import "./App.css";
function App() {
    return (_jsx(ThemeProvider, { defaultTheme: "light", children: _jsxs(Routes, { children: [_jsxs(Route, { element: _jsx(UserLayout, {}), children: [_jsx(Route, { path: "/", element: _jsx(HomePage, {}) }), _jsx(Route, { path: "/program-overview", element: _jsx(ProgramOverviewPage, {}) }), _jsx(Route, { path: "/about", element: _jsx(AboutUsPage, {}) }), _jsx(Route, { path: "/contact", element: _jsx(ContactUsPage, {}) }), _jsx(Route, { path: "/register", element: _jsx(RegisterPage, {}) }), _jsx(Route, { path: "/login", element: _jsx(LoginPage, {}) }), _jsxs(Route, { element: _jsx(ProtectedRoute, {}), children: [" ", _jsx(Route, { path: "/profile", element: _jsx(UserProfilePage, {}) })] }), _jsxs(Route, { element: _jsx(ProtectedRoute, { requiredRole: "student" }), children: [_jsx(Route, { path: "/dashboard", element: _jsx(DashboardPage, {}) }), _jsx(Route, { path: "/courses", element: _jsx(CoursesPage, {}) }), _jsx(Route, { path: "/courses/:id", element: _jsx(CourseDetailPage, {}) }), _jsx(Route, { path: "/course-introduction", element: _jsx(CourseIntroductionPage, {}) }), _jsx(Route, { path: "/discussions", element: _jsx(DiscussionForumPage, {}) }), _jsx(Route, { path: "/discussions/:courseId", element: _jsx(DiscussionForumPage, {}) }), _jsx(Route, { path: "/courses/:courseId/week/:weekId", element: _jsx(WeekContentPage, {}) })] })] }), _jsx(Route, { element: _jsx(ProtectedRoute, { requiredRole: "admin" }), children: _jsxs(Route, { element: _jsx(AdminLayout, {}), children: [_jsx(Route, { path: "/admin", element: _jsx(AdminPage, {}) }), _jsx(Route, { path: "/admin/courses", element: _jsx(AdminCourseManagementPage, {}) }), _jsx(Route, { path: "/admin/students", element: _jsx(AdminStudentManagementPage, {}) }), _jsx(Route, { path: "/admin/reports", element: _jsx(AdminReportsPage, {}) }), _jsx(Route, { path: "/admin/settings", element: _jsx(AdminSettingsPage, {}) })] }) })] }) }));
}
export default App;
